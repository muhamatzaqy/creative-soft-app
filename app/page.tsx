...
export default function Home() {
  return (
    <div className="min-h-screen bg-slate-50 font-sans selection:bg-indigo-200 selection:text-indigo-900 overflow-hidden relative">

      {/* BACKGROUND DECORATION (Modern Glow Effect) */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[1000px] h-[600px] opacity-30 pointer-events-none z-0">
      ...
      <section id="alur" className="py-24 bg-white border-y border-slate-100 relative z-10">
      ...
      <footer className="bg-slate-950 py-16 border-t border-slate-900 relative z-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <a
        href="https://wa.me/6285600471854"
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-6 right-6 sm:bottom-8 sm:right-8 z-[100] group flex items-center gap-3"
        aria-label="Hubungi kami via WhatsApp"
      >
        {/* Tooltip teks */}
        <span className="hidden sm:block px-4 py-2 bg-white text-slate-700 text-sm font-bold border border-slate-200 rounded-xl shadow-lg opacity-0 translate-x-4 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-300">
          Hubungi Admin
        </span>
        
        {/* Tombol Utama (Ikon WA) */}
        <div className="relative">
          <div className="absolute inset-0 bg-[#25D366] rounded-full animate-ping opacity-60"></div>
          <div className="relative bg-[#25D366] text-white p-3.5 sm:p-4 rounded-full shadow-2xl group-hover:scale-110 transition-transform duration-300 flex items-center justify-center">
